...
class OrderListNotDemand extends Component {
    constructor(props) {
        super(props)
        this.state = {
    ...
    componentDidMount() {
        ...
        InteractionManager.runAfterInteractions(getOrderListNotDemand)
    }
        ...
        return (
            <Container>
                <FlatList
                    ...
                    ListEmptyComponent={orderListNotDemandReducer.getOrderListNotDemand.isResultStatus != 1 && orderListNotDemand.length == 0 && renderListEmpty}
...
const mapDispatchToProps = (dispatch) => ({
    getOrderListNotDemand: req => {
        dispatch(reduxActions.orderListNotDemand.getOrderListNotDemand(req))
    },
    getOrderListNotDemandWaiting: () => {
        dispatch(reduxActions.orderListNotDemand.getOrderListNotDemandWaiting())
    },
    getOrderListNotDemandMore: () => {
...
export default connect(mapStateToProps, mapDispatchToProps)(OrderListNotDemand)