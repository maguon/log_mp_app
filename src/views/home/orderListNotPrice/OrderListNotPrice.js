...
class OrderListNotPrice extends Component {
    ...
    componentDidMount() {
        ...
        getOrderListNotPriceWaiting()
        InteractionManager.runAfterInteractions(getOrderListNotPrice)
    }
...
const mapDispatchToProps = (dispatch) => ({
    getOrderListNotPrice: req => {
        dispatch(reduxActions.orderListNotPrice.getOrderListNotPrice(req))
    },
    getOrderListNotPriceWaiting: () => {
        dispatch(reduxActions.orderListNotPrice.getOrderListNotPriceWaiting())
    },
    getOrderListNotPriceMore: () => {
...
export default connect(mapStateToProps, mapDispatchToProps)(OrderListNotPrice)