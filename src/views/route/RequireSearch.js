            ...
            <Content>
                ...
                <View style={[{ justifyContent: 'space-between', flexDirection: 'row' }]}>
                    <Button style={[{
                        ...
                        onPress={() => {
                            dispatch(destroy('requireSearchForm'))
                        }}>
...
export default connect(null, mapDispatchToProps)(reduxForm({
    form: 'requireSearchForm',
    onSubmit: (values, dispatch, props) => {
        dispatch(reduxActions.requireTaskList.getRequireTaskListWaiting())
        InteractionManager.runAfterInteractions(() => dispatch(reduxActions.requireTaskList.getRequireTaskList(values)))
    }
})(RequireSearch))