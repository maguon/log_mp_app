...
const NavBar = props => {
    const { title, RightButton, LeftButton, parent, initParam, layout: { initWidth }, preSceneKey, sceneKey,...restProps } = props
    return (
        <View style={[styles.container, { width }]}>
            ...
            <Header
                ...
                {LeftButton && <Left style={{ flex: 1 }}>
                    <LeftButton parent={parent} preSceneKey={preSceneKey} />
                </Left>}
