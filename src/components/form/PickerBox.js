...
export default class PickerBox extends Component {
    ...
    render() {
        ...
        return (
            <TouchableOpacity style={[styles.body,{ borderBottomWidth: !last ? 0.3 : 0 }]} onPress={() => this.setState({ modalVisible: true })}>
                <View style={[styles.item, itemStyle]}>
                    ...
                    <View style={{ flexDirection: 'row', alignItems: 'center' }}>
                        ...
                        <Icon name='ios-arrow-down' color='#777' fontSize={15} style={{ fontSize: 18, color: '#bbb', paddingLeft: 15 }} />
                    </View>
                </View>
